...
case $1 in
    ...
    ;;     
    "all_slow")
hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_interaction_comment_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_interaction_favor_add_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_tool_coupon_get_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_tool_coupon_order_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_tool_coupon_pay_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_trade_cancel_detail_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_trade_cart_add_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_trade_cart_full"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_trade_order_detail_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_trade_order_refund_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_trade_pay_detail_suc_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_trade_refund_pay_suc_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_traffic_action_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_traffic_display_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_traffic_error_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_traffic_page_view_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_traffic_start_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_user_login_inc"
sleep 5

hive -e "SET hive.exec.dynamic.partition.mode=nonstrict; $dwd_user_register_inc"
sleep 5
